...
public final class ModRecipes {
    ...
    public static void postInit() {
        ItemStack controller = AEApi.instance().definitions().blocks().controller().maybeStack(1).orNull();
        ItemStack wirelessHub = AEApi.instance().definitions().blocks().wirelessHub().maybeStack(1).orNull();
        ItemStack wirelessTool = AEApi.instance().definitions().items().toolWirelessKit().maybeStack(1).orNull();
        ItemStack wireless = AEApi.instance().definitions().materials().wireless().maybeStack(4).orNull();
